			...
			<form action="Main" name="sign up" role="form"
				...
				<div class="row">
					<ul class="nav nav-tabs">
						<li><a href="Main?op=annulerJournal">Détail Journal</a></li>
						<li class="active"><a href="Main?op=RmodifierJournal">Modifier/Supprimer</a></li>
					</ul>
							...
							<div class="col-md-offset-0 col-md-8">
								<div class="btn-group btn-group-lg">
									<br> <input class="btn btn-success" type="button"
										value="Modifier"
										onclick="this.form.op.value='modifierJournal'; this.form.submit();" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="col-md-offset-0 col-md-8">
								<div class="btn-group btn-group-lg">
									<br> <input class="btn btn-danger" type="button"
										value="Supprimer"
										onclick="this.form.op.value='supprimerJournal';this.form.submit();" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="col-md-offset-0 col-md-8">
								<div class="btn-group btn-group-lg">
									<br> <input class="btn btn-default" type="button"
										value="Annuler"
										onclick="this.form.op.value='annulerJournal'; this.form.submit();" />
								</div>
							</div>
						</div>
					</div>
