...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>Travaux ayant soumis</title>
<!-- Bootstrap -->
<!-- --------------------CSS-------------------------------------------------- -->
	...
	<div class=container>
		...
		<div class="col-md-9">
			<ul class="nav nav-tabs">
				...
				<li class="active"><a href="Main?op=travauxAyantSoumisJ">Travaux
						ayant soumis</a></li>
				<li><a href="Main?op=travauxCiblantsJ">Travaux Ciblant</a></li>
			</ul>
			<h3>Liste des travaux ayant soumis au journal</h3>

			<%
				if (versions.isEmpty()) {
			%>
			<p>
				Vous n'avez aucun travail ayant soumis à ce journal. <a
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							...
							&id=<%=id%>" title="oussama"><%=titre%></a></td>
							<td>
								<%if(v.isAccepte()){ %>
								<p style="color: green;">Accéptée</p> <%} else if(v.isRefuse()) { %>
								<p style="color: red;">Refusée</p> <%} else { %>
