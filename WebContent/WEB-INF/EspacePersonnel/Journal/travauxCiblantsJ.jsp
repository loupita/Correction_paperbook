		...
		<div class="col-md-9">
			<ul class="nav nav-tabs">
				...
				<li><a href="Main?op=travauxAyantSoumisJ">Travaux ayant
						soumis</a></li>
				<li class="active"><a href="Main?op=travauxCiblantsJ">Travaux
						Ciblant</a></li>
			</ul>
			<h3>Liste des travaux ciblant ce journal</h3>

			<%
				if (travaux.isEmpty()) {
			%>
			<p>
				Vous n'avez aucun travail qui cible ce journal. <a
