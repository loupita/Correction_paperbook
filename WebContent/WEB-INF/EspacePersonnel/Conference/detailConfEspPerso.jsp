...
<body>
	<%
		...
		String lieu = evt.getLieuEvt();
		String date = evt.getdateEvt();
		String dateNotif = evt.getDateNotifAcceptance();
	...
	<div class="col-md-2 offset2">
		<div class="list-group">
			<a class="list-group-item" href="Main?op=mur"><i
				...
				class="list-group-item active" href="Main?op=detailConfEspPerso"><i
	...
	<div class=container>
		...
		<div class="col-md-9">
			<ul class="nav nav-tabs">
				<li class="active"><a href="Main?op=detailConfEspPerso">Détail
						Conférence</a></li>
				<li><a href="Main?op=RmodifierConfEspPerso">Modifier/Supprimer</a></li>
				<li><a href="Main?op=travauxAyantSoumisC">Travaux ayant
						soumis</a></li>
			...
			<ul>
				<li>L'événement aura lieu le : <mark><%=date%></mark></li>
				...
				%>
				<li>La réponse vous sera communiquer le : <mark><%=dateNotif%></mark></li>
			</ul>
			<br> <br>
			<div class="panel panel-info">
				<div class="panel-heading">La publication doit être conforme à
					ce qui a été demandé par les organisateurs :</div>
				<div class="panel-body">
					...
					%>
					<a href="Main?op=fichierStyleConf">fichier</a>
					<%
						}
					%>
				</div>
