...
<body>
	<%
		...
		Collection<Travail> travaux = (Collection<Travail>) request
				.getAttribute("travaux");
	%>
	<!-- Header -->
		<!-- Fixed navbar -->
	...
	<div class=container>
		...
		<ul class="nav nav-tabs">
				...
				<li class="active"><a href="Main?op=travauxCiblantsC">Travaux Ciblant</a></li>
			</ul>
			<h3>Liste des travaux ciblant la conférence</h3>

			<%
				if (travaux.isEmpty()) {
			%>
			<p>Vous n'avez aucun travail qui cible cette conférence. <a href="Main?op=RajouterTravail">ajoutez un travail</a></p>
			<%
				} else {
			%>
