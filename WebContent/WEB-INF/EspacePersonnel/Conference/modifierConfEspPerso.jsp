...
<body>
	<%
		...
		Conference evt = (Conference) session.getAttribute("conf");
		String site = evt.getSite();
		String titre = evt.getTitre();
		String acr = evt.getAcronym();
		String lieu = ((Conference) evt).getLieuEvt();
		String date = ((Conference) evt).getdateEvt();
		String dateNotif = ((Conference) evt).getDateNotifAcceptance();
				...
				<div class="row">
					<ul class="nav nav-tabs">
						<li><a href="Main?op=annulerConfEspPerso">Détail
								Conférence</a></li>
						<li class="active"><a href="Main?op=RmodifierConfEspPerso">Modifier/Supprimer</a></li>
						<li><a href="Main?op=travauxAyantSoumisC">Travaux ayant soumis</a></li>
					...
					<div class="col-xs-4">
						...
						<div class="form-group">
							<div class="col-md-8">
								<br> <br>
								<h6>Acronym :</h6>
								<label for="acr" class="sr-only">Acronym</label> <input
									type="text" id="acr" name="acr" class="form-control"
									placeholder="Acronym" required autofocus
									value="<%=acr%>">
							</div>
						</div>
						<p></p>
						...
						<div class="form-group" id="lieu">
							<div class="col-md-8">
								...
								<label for="pays" class="sr-only">Lieu événement</label> <input
									...
									placeholder="Lieu événement" required autofocus
									value="<%=lieu%>">
							</div>
						</div>
						...
						<div class="form-group" id="dateEvt">
							<div class="col-md-8">
								...
								<label for="date1" class="sr-only">date de l'événement</label> <input
									...
									placeholder="date de l'événement" required autofocus
									value="<%=date%>">
							</div>
						</div>
						<p></p>
						...
						<div class="form-group" id="dateNotif">
							<div class="col-md-8">
								...
								<label for="date4" class="sr-only">date notification
									...
									required autofocus value="<%=dateNotif%>">
							</div>
						</div>
					</div>
					<!-------------------------------------- 3eme COLONNE --------------------------------------------------->
							...
							<div class="col-md-offset-0 col-md-8">
								<div class="btn-group btn-group-lg">
									<br> <input class="btn btn-success" type="button"
										value="Modifier"
										onclick="this.form.op.value='modifierConfEspPerso'; this.form.submit();" />
								</div>
							</div>
						</div>
					</div>
							...
							<div class="col-md-offset-0 col-md-8">
								<div class="btn-group btn-group-lg">
									<br> <input class="btn btn-danger" type="button"
										value="Supprimer"
										onclick="this.form.op.value='supprimerConfEspPerso'; this.form.submit();" />
							...
							<div class="col-md-offset-0 col-md-8">
								<div class="btn-group btn-group-lg">
									<br> <input class="btn btn-default" type="button"
										value="Annuler"
										onclick="this.form.op.value='annulerConfEspPerso'; this.form.submit();" />
								</div>
							</div>
						</div>
					</div>
