...
<body>
	<%
		...
		Collection<Travail> travaux_soumis_rep = (Collection<Travail>) request
				.getAttribute("travaux_soumis_rep");
	%>
	<!-- Header -->
	<!-- Fixed navbar -->
	...
	<div class="col-md-2 offset2">
		<div class="list-group">
			<a class="list-group-item" href="Main?op=mur"><i
				...
				class="list-group-item active" href="Main?op=listeTravaux"><i
	...
	<div class=container>
		...
		<div class="col-md-9">
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<p>Pas de délai attendu</p> <%} else if(t.getJourRestant() < 0){ %>
			...
			<p>
				Pour ajouter un nouveau travail <a href="Main?op=RajouterTravail">cliquer  ici.
			</a> 
			</p>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<p style="color: green;"><%=t.getJourRestant()%>
									jours
								</p> <%} else if(t.getJourRestant()==-1000000) { %>
								<p>Pas de délai attendu</p> <%} else if(t.getJourRestant() < 0){ %>
								<p style="color: red;">délai dépassé</p> <%} %>
							</td>
						</tr>
			...
			<br> <br>
			<h1>Liste des travaux soumis avec réponse</h1>

			<%
				if (travaux_soumis_rep.isEmpty()) {
			%>
			<p>Vous n'avez aucun travail soumis avec une réponse.</p>
			<%
				} else {
			%>
			<div class="table-responsive">
				<table class="table table-hover">
					...
					<%
						int cpt = 1;
							for (Travail t : travaux_soumis_rep) {
								int id = t.getId();
					%>
					<tbody>
						<tr>
