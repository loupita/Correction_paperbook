...
<body>
	<%
		...
		Collection<Evenement> events = (Collection<Evenement>) request
				.getAttribute("events");
		Evenement eventParticulier = (Evenement) request
				.getAttribute("eventParticulier");
	%>
	<!-- Header -->
		<!-- Fixed navbar -->
	...
	<div id="main" class=container>
		<div class="col-md-10">
			...
			<h3>Résultats</h3>
			<br>
			<%if(eventParticulier!=null && eventParticulier.getTauxDeSucces()!=-1){%>
						<p align="center" style="color:red;"><%=eventParticulier.getTitre()%></p>
						 <div class="progress" align=center>
							  <div class="progress-bar  progress-bar-success" role="progressbar" 
							  aria-valuenow="<%=eventParticulier.getTauxDeSucces()%>"
							  aria-valuemin="0" aria-valuemax="100" style="width:<%=eventParticulier.getTauxDeSucces()%>%">
							    <%=eventParticulier.getTauxDeSucces()%>%
							  </div>
						</div>
						<br><br><br>
						<%
				...
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><%=cpt%></td>
							<td><a
								href="Main?op=detail<%=detail%>EspPerso&id=<%=evt.getId()%>">
									<%=evt.getTitre()%></td>
							<td><%=nbPapier%></td>
							<td><%=nbPapierA%></td>
							<td><%=nbPapierR%></td>
